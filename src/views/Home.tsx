...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white font-sora text-black selection:bg-[#8cff2e] selection:text-black dark:bg-black dark:text-white">
      ...
      <section
        ref={previewRef}
        className="relative h-[500px] overflow-hidden border-y border-white/10 bg-black md:h-[650px]"
      >
        <div className="absolute inset-x-0 top-0 z-10 h-32 bg-gradient-to-b from-black/95 to-transparent" />
        ...
        <div className="absolute inset-x-0 bottom-0 z-10 h-32 bg-gradient-to-t from-black/95 to-transparent" />
      </section>
