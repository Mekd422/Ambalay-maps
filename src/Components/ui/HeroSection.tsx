...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-black px-6 pb-16 pt-28 md:px-12 md:pb-16 md:pt-36">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        <div className="mb-8 inline-flex items-center justify-center rounded-full border border-[#8cff2e]/30 bg-black/50 px-4 py-1.5 shadow-[0_0_20px_rgba(140,255,46,0.15)] backdrop-blur-sm">
          <span className="font-sora text-[11px] font-bold uppercase tracking-wider text-[#8cff2e]">
            from heights we see clearly
          </span>
        </div>
        <h1 className="mb-4 text-4xl font-medium leading-tight text-white sm:text-5xl md:text-6xl">
          Build smarter with Ambalay Maps
        </h1>

        <p className="mx-auto mb-8 max-w-2xl text-sm leading-relaxed text-gray-400 sm:text-base md:text-lg">
