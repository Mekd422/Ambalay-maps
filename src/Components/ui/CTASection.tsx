...
export default function CTASection() {
  return (
    <section className="relative overflow-visible bg-black px-6 py-16 md:px-12">
      <div className="relative mx-auto max-w-5xl selection:bg-[#8cff2e] selection:text-black">
        <div className="relative z-10 overflow-hidden rounded-[32px] border border-white/5 bg-[#0d0d0d] p-8 md:p-12">
          <div className="relative z-30 max-w-sm">
            <h2 className="mb-4 text-3xl font-medium leading-tight tracking-tight text-white md:text-4xl">
              Ready to Build with <br /> AmbaLay Maps?
            </h2>
            <p className="mb-8 text-xs leading-relaxed text-gray-400 md:text-sm">
        ...
        <div className="pointer-events-none absolute -bottom-8 -right-2 z-20 w-[220px] md:-bottom-12 md:w-[320px]">
          <div className="relative">
            <Image
              ...
              width={320}
              height={480}
              className="h-auto w-full scale-150 select-none object-contain"
              style={{
                maskImage:
                  'linear-gradient(to bottom, black 35%, rgba(0,0,0,0.6) 65%, transparent 95%)',
                WebkitMaskImage:
                  'linear-gradient(to bottom, black 35%, rgba(0,0,0,0.6) 65%, transparent 95%)',
              }}
            />
